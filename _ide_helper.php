...
namespace {
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model{
        ...
        /**
         * Get the hydrated Entity without eager loading.
         *
         * @param array $columns
        ...
        /**
         * Eager load the relationships for the Entity.
         *
         * @param array $models
         * @return array 
         * @static 
    ...
    class Route extends \Illuminate\Support\Facades\Route{
        ...
        /**
         * Set a global where pattern on all router
         *
         * @param string $key
         * @param string $pattern
         * @return void 
        ...
        /**
         * Set a group of global where patterns on all router
         *
