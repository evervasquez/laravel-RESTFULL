...
<body>
    ...
    <script type="text/template" id="facultad-template">
        <li><%= name %></li>
        <li><%= id %></li>
    </script>
    ...
    {{ HTML::script('assets/js/backbone/models/facultad.js') }}
    {{ HTML::script('assets/js/backbone/models/materia.js') }}
    {{ HTML::script('assets/js/backbone/collections/facultad.js') }}
    {{ HTML::script('assets/js/backbone/collections/materia.js') }}
    {{ HTML::script('assets/js/backbone/views/facultad.js') }}
    {{ HTML::script('assets/js/backbone/views/facultads.js') }}


    {{ HTML::script('assets/js/backbone/router/router.js') }}
